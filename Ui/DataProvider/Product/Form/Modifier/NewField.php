<?php
namespace DamConsultants\BynderTheisens\Ui\DataProvider\Product\Form\Modifier;
                        ...
                        'data' => [
                            'config' => [
                                ...
                                "content" => $this->layoutFactory->create()->createBlock(
                                    \DamConsultants\BynderTheisens\Block\Adminhtml\Catalog\Product\Form\Gallery::class
                                )->toHtml(),
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'behaviourType' => 'edit',
                                "content" => $this->layoutFactory->create()->createBlock(
                                    \DamConsultants\BynderTheisens\Block\Adminhtml\Catalog\Product\Form\BynderDoc::class
                                )->toHtml(),
                                'externalFilterMode' => true,
                                'currentProductId' => $this->locator->getProduct()->getId(),
                            ],
