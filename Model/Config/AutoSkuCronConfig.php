...
namespace DamConsultants\BynderTheisens\Model\Config;
    ...
    public function afterSave()
    {
        ...
        if ($frequency == $every_min) {
            ...
            $cronExprArray = [
                (int)$time[1], /*Minute*/
                (int)$time[0], /*Hour*/
                $frequency == \DamConsultants\BynderTheisens\Model\Config\Source\Frequency::CRON_MONTHLY ?
                '1' : '*', /*Day of the Month*/
                '*', /*Month of the Year*/
                $frequency == \DamConsultants\BynderTheisens\Model\Config\Source\Frequency::CRON_WEEKLY ?
                '1' : '*', /*Day of the Week*/
            ];
        }
