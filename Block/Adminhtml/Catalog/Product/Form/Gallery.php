<?php
namespace DamConsultants\BynderTheisens\Block\Adminhtml\Catalog\Product\Form;
...
class Gallery extends \Magento\Backend\Block\Template
{
    ...
    {
        return $this->getViewFileUrl('DamConsultants_BynderTheisens::images/drag.png');
    }
    /**
     * Image.
     *
    ...
    {
        return $this->getViewFileUrl('DamConsultants_BynderTheisens::images/delete_.avif');
    }
    /**
     * Json.
     *
